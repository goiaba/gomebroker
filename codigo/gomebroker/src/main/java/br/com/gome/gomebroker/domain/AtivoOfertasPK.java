 ...
 */
@Embeddable
public class AtivoOfertasPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AtivoOfertasPK)) {
			return false;
		}
		AtivoOfertasPK castOther = (AtivoOfertasPK)other;
		return 
