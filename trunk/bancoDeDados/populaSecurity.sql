...
insert into sec_recurso values (1, 'faces resources', '', 'private_starts_with_url','/javax.faces.resource/', now(), current_timestamp + 365 * interval '1 day');
...
insert into sec_recurso values (4, 'css resources', '', 'private_starts_with_url','/css/', now(), current_timestamp + 365 * interval '1 day');
